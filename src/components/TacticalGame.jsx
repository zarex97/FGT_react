    ...
    const handleReceiveAttack = () => {
      ...
      const combat = new Combat({
        typeOfAttackCausingIt:
          unit.statusIfHit.combatReceived.typeOfAttackCausingIt, //e.g: skill, np, basic attack
        proportionOfMagicUsed:
          unit.statusIfHit.combatReceived.proportionOfMagicUsed, // e.g: 30% of magic
        proportionOfStrengthUsed:
          unit.statusIfHit.combatReceived.proportionOfStrengthUsed, //e.g: 120% of strength
        attacker: currentAttacker,
        defender: currentDefender,
        gameState: gameState,
        integratedAttackMultiplier:
          unit.statusIfHit.combatReceived.integratedAttackMultiplier, //e.g: multiplier bonus on np/skill description
        integratedAttackFlatBonus:
          unit.statusIfHit.combatReceived.integratedAttackFlatBonus, // e.g: flat bonus on np/skill description
      });
